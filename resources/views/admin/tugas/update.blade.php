        ...
        <form action="{{ route('tugasUpdate',$tugas->id) }}" method="post">
            ...
            <div class="row mb-2">
                <div class="col-xl-6 mb-2">
                    ...
                    <input type="date" name="tanggal_mulai" class="form-control @error ('tanggal_mulai') is-invalid @enderror" value="{{ $tugas->tanggal_mulai}}">
                    @error('tanggal_mulai')
                        <small class="text-danger">
                            {{ $message }}
                        </small>
                ...
                <div class="col-xl-6 mb-2">
                    ...
                    <input type="date" name="tanggal_selesai" class="form-control @error ('tanggal_selesai') is-invalid @enderror" value="{{ $tugas->tanggal_selesai}}">
